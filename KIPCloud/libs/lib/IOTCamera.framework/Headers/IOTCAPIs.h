...
/**
* \brief Setup device Search virtual port
*
* \details The default virtual port of device search is 0, and the maximum port number is 3,
*		   Both device and client must have the same virtual port, otherwise client cannot find 
*		   device by IOTC_Device_Search_Start or IOTC_LAN_Search
*
* \param nPort [in] The default virtual port of device search is 0, and the maximum channel number is 3 
*
* \attention The IOTC_Setup_Device_Search_VirtualPort must be called before IOTC_Initialize or IOTC_Initialize2
*
* \return Return 0 if IOTC_Setup_Device_Search_VirtualPort() call successfully.
* \return Error code if return value < 0
*			- #IOTC_ER_INVALID_ARG The arguments passed in to this function is invalid.
*
**/
P2PAPI_API int IOTC_Setup_Device_Search_VirtualPort(int nPort);
