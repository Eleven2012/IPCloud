...
#define KYL_PT_SPEED 8
#define KYL_PT_DELAY 1.5
// Uniform index.
enum {
    UNIFORM_VIDEOFRAME,
    UNIFORM_INPUTCOLOR,
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (direction != DirectionNone) {
        ...
        if (self.delegate && [self.delegate respondsToSelector:@selector(monitor:gestureSwiped:)]) {
            ...
            [self performSelector:@selector(stopPT) withObject:nil afterDelay:KYL_PT_DELAY];
        }
    }
}
