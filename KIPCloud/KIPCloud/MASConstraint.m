...
- (MASConstraint * (^)(NSValue *value))valueOffset {
    return ^id(NSValue *offset) {
        NSAssert1([offset isKindOfClass:NSValue.class], @"expected an NSValue offset, got: %@", offset);
...
- (void)setLayoutConstantWithValue:(NSValue *)value {
    if ([value isKindOfClass:NSNumber.class]) {
        ...
        NSAssert1(NO, @"attempting to set layout constant with unsupported value: %@", value);
    }
}
