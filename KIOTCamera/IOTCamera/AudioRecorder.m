...
- (id)initAudioRecorderWithAvIndex:(NSInteger)avIndex_ Codec:(NSInteger)codec_ AudioFormat:(AudioStreamBasicDescription)format_ Delegate:(id<AudioRecordDelegate>)delegate_ {
